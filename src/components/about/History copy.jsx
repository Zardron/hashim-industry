import Hashim from "../../assets/img/hashim1.jpg";
import Hashim2 from "../../assets/img/hashim.jpg";
import Hashim3 from "../../assets/img/hashim2.jpg";
    ...
    <div className="bg-white dark:bg-dark">
      ...
      >
        ...
        <p className="text-dark text-justify dark:text-white text-[16px] leading-6 normal-case leading font-normal pt-3">
          ...
          Hashim Industry supremacy in advanced plastics in the region as well
          as worldwide.
        </p>
        <p className="text-dark text-justify dark:text-white text-[16px] leading-6 normal-case leading font-normal pt-3">
        ...
        <p className="text-dark text-justify dark:text-white text-[16px] leading-6 normal-case leading font-normal pt-3">
          The shrewd leader in Mr.Hashim saw the opportunity in the construction
        ...
        <p className="text-dark text-justify dark:text-white text-[16px] leading-6 normal-case leading font-normal pt-3">
          In a nutshell, every initiative taken by the Hashim Industry is guided
