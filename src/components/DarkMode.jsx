...
const DarkMode = ({ darkMode, setDarkMode }) => {
  return (
    <div className="group fixed bottom-14 lg:bottom-5 right-5 p-2 rounded-lg bg-white  border-2 border-primary dark:bg-dark dark:border-primary dark:border-2 z-50 hover:bg-dark">
      {darkMode === "light" ? (
        <MdNightlight
