...
const OurPartner = () => {
  return (
    <div
      className="flex-container dark:bg-dark mb-10 dark:mb-0"
      data-aos="zoom-in"
      data-aos-delay="100"
      ...
      <div className="slider-container pb-2">
        <ul className="slider">
          <Link to="/about-us" state={{ props: "partners" }}>
            <li className="slider__slide border-r-[15px] border-r-white dark:border-r-dark group">
              <div className="slide__content scale-95">
                <img
                  src={Partner1}
                  alt=""
                  className="rounded-lg shadow-3d border border-shadow group-hover:scale-105 transition-all ease-linear duration-100"
                />
              </div>
            </li>
          </Link>
