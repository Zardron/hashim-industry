  ...
  return (
    <>
      <div
        ...
        } group fixed bottom-36 lg:bottom-20 right-5 p-2 rounded-lg bg-white border-2 border-primary dark:bg-dark dark:border-primary dark:border-2 z-50 hover:bg-dark group`}
      >
