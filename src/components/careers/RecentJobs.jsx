      ...
      <div className="bg-white dark:text-white dark:bg-dark mt-3">
        ...
        >
          <div className="bg-primary flex flex-row items-center justify-between p-4 rounded-t-lg">
            <div className="w-3/4">
              <p className="text-white font-semibold leading-tight text-lg capitalize">
                Job Title:
              </p>
              <p className="text-white font-normal text-[16px] capitalize">
                SALES ENGINEER
              </p>
            </div>
            <div className="w-1/4">
          ...
          <div className="bg-[#f0ffff] flex flex-row items-center justify-between p-4 rounded-b-lg border border-primary">
            <div className="w-3/4">
              <p className="text-dark font-semibold leading-tight text-[16px] capitalize">
                Job Description:
              </p>
              <p className="text-dark font-normal leading-tight text-[16px] capitalize">
